...
class Message(models.Model):
    ...
    user_msg = models.ForeignKey(User, related_name="msg", on_delete=models.CASCADE)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)

    def __repr__(self):
        return f"User: {self.user_msg}, Message: {self.msg}"

class Comment(models.Model):
    cmt = models.TextField()
    user_cmt = models.ForeignKey(User, related_name="cmt", on_delete=models.CASCADE)
    msg_cmt = models.ForeignKey(Message, related_name="cmt", on_delete=models.CASCADE)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
